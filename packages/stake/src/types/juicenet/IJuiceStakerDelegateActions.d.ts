...
interface IJuiceStakerDelegateActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IJuiceStakerDelegateActions extends BaseContract {
  ...
  interface: IJuiceStakerDelegateActionsInterface;
