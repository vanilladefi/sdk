...
interface MockBadJuiceStakingUpgradeInterface extends ethers.utils.Interface {
  functions: {
...
export class MockBadJuiceStakingUpgrade extends BaseContract {
  ...
  interface: MockBadJuiceStakingUpgradeInterface;
