 ...
 */
export function getVanillaTokenContract(version, signerOrProvider) {
    const address = tradeContractAddresses.vanilla[version]?.vnl;
    return ERC20__factory.connect(address || '', (signerOrProvider || providers.getDefaultProvider()));
}
/**
 ...
 */
export function getVanillaTradeRouter(version, signerOrProvider) {
    ...
    return version !== VanillaVersion.V1_0
        ? VanillaV1Router02__factory.connect(routerAddress || '', (signerOrProvider || providers.getDefaultProvider()))
        : new Contract(tradeContractAddresses.vanilla.v1_0?.router || '', v1abi, signerOrProvider || providers.getDefaultProvider());
}
/**
 ...
 */
export const network = providers.getNetwork(chainId);
/**
 ...
 */
export function getFeeTier(input) {
 ...
 */
export const conservativeGasLimit = 800000;
/**
 * Conservative gas limit to use for $VNL token migration
 */
export const conservativeMigrationGasLimit = 120000;
/**
