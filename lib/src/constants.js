...
exports.default = {
    contractAddresses: exports.contractAddresses,
    epoch: exports.epoch,
    chainId: exports.chainId,
    network: exports.network,
    hiddenTokens: exports.hiddenTokens,
    getFeeTier: getFeeTier,
    blockDeadlineThreshold: exports.blockDeadlineThreshold,
    conservativeGasLimit: exports.conservativeGasLimit,
    conservativeMigrationGasLimit: exports.conservativeMigrationGasLimit,
    ethersOverrides: exports.ethersOverrides,
};
