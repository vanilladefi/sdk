    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, vnlRouter.queryFilter(purchaseFilter, constants_1.epoch)];
            case 1:
                events = _a.sent();
                events.forEach(function (event) {
                    var walletAddress = (0, tokens_1.isAddress)(event.args.buyer);
                ...
                return [4 /*yield*/, vnlLegacyRouter.queryFilter(legacyFilter, constants_1.epoch)];
            case 2:
...
var getBasicWalletDetails = function (vanillaVersion, walletAddress, provider) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                vnlBalance = _b.apply(void 0, [_d.sent(), constants_1.vnlDecimals]);
...
var getVnlHolders = function (provider) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                vnlToken = ERC20__factory_1.ERC20__factory.connect(constants_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_1].vnl, provider || ethers_1.providers.getDefaultProvider());
                vnlRouter = (0, contracts_1.getVanillaRouter)(general_1.VanillaVersion.V1_1, provider || ethers_1.providers.getDefaultProvider());
            ...
            case 2:
                ...
                vnlHolders = new Set();
                events.forEach(function (event) {
                    event.args.from !== v3_sdk_1.ADDRESS_ZERO && vnlHolders.add(event.args.from);
                    event.args.to !== v3_sdk_1.ADDRESS_ZERO && vnlHolders.add(event.args.to);
                });
