...
var buy = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    router = (0, tokens_1.getContract)(constants_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_0].router, JSON.stringify(vanillaRouter_json_1.default.abi), signer);
                    usedGasLimit = gasLimit !== undefined ? gasLimit : constants_1.ethersOverrides.gasLimit;
...
function tryParseAmount(value, currency) {
    ...
    try {
        var convertedToken = new sdk_1.Token(constants_1.chainId, (0, utils_1.getAddress)(currency.address), Number(currency.decimals));
