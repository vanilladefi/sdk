                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, oracle.callStatic.quoteExactInputSingle(swapParams.tokenIn, swapParams.tokenOut, fee, swapParams.amountIn, swapParams.sqrtPriceLimitX96, {
                                        gasLimit: constants_1.conservativeGasLimit,
                                    })];
...
var buy = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    vnl1_1Addr = (0, tokens_1.isAddress)(constants_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_1].router);
                    ...
                    usedGasLimit = gasLimit ? gasLimit : constants_1.ethersOverrides.gasLimit;
                    orderData = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    feeTier = (0, constants_1.getFeeTier)(tokenReceived.fee) ||
                        (0, constants_1.getFeeTier)(tokenPaid.fee) ||
                        defaultFeeTier;
                    uniV3Oracle = uniswap_v3_periphery_1.Quoter__factory.connect(constants_1.contractAddresses.uniswap.v3.quoter, signerOrProvider);
...
function tryParseAmount(value, currency) {
    ...
    try {
        var convertedToken = new sdk_core_1.Token(constants_1.chainId, (0, utils_1.getAddress)(currency.address), Number(currency.decimals));
