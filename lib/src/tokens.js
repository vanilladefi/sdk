...
var default_token_list_1 = require("@uniswap/default-token-list");
...
var tokens_v1_0_json_1 = require("./tokenLists/tokens_v1_0.json");
var tokens_v1_1_json_1 = require("./tokenLists/tokens_v1_1.json");
// WETH stuff
var defaultWeth = {
    chainId: String(constants_1.chainId),
...
exports.weth = ((_a = getAllTokens(general_1.VanillaVersion.V1_0)) === null || _a === void 0 ? void 0 : _a.find(function (token) {
    return token.chainId === String(constants_1.chainId) && token.symbol === defaultWeth.symbol;
})) || defaultWeth;
exports.usdc = (_b = getAllTokens(general_1.VanillaVersion.V1_0)) === null || _b === void 0 ? void 0 : _b.find(function (token) { return token.chainId === String(constants_1.chainId) && token.symbol === 'USDC'; });
exports.vnl = {
    chainId: String(constants_1.chainId),
    address: constants_1.contractAddresses.vanilla.v1_1.vnl,
    decimals: String(constants_1.vnlDecimals),
    symbol: 'VNL',
    name: 'Vanilla',
    logoColor: null,
    pairId: null,
...
function getAllTokens(version) {
    ...
    return allTokens
        ...
        return token.chainId === String(constants_1.chainId) &&
