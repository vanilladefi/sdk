        ...
        switch (_b.label) {
            case 0:
                ...
                router = version === general_1.VanillaVersion.V1_0
                    ? new ethers_1.ethers.Contract(contracts_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_0].router, JSON.stringify(vanillaRouter_json_1.default.abi), signerOrProvider)
                    : vanilla_v1_1_1.VanillaV1Router02__factory.connect(contracts_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_1].router, signerOrProvider);
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
var estimateGas = function (version, trade, signer, provider, operation, token0, slippageTolerance) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                routerV1_0 = new ethers_1.ethers.Contract(contracts_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_0].router, JSON.stringify(vanillaRouter_json_1.default.abi), signer);
                routerV1_1 = vanilla_v1_1_1.VanillaV1Router02__factory.connect(contracts_1.contractAddresses.vanilla[general_1.VanillaVersion.V1_1].router, signer);
            ...
            case 2:
                block = _a.sent();
                blockDeadline = block.timestamp + contracts_1.blockDeadlineThreshold;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, spotPrice_1.getSpotPrice)(contracts_1.usdcWethPoolAddress, (0, tokens_1.convertVanillaTokenToUniswapToken)(tokens_1.usdc), (0, tokens_1.convertVanillaTokenToUniswapToken)(tokens_1.weth))];
                case 1:
                    ETHPrice = (_a.sent())[0];
                    positions = [];
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        vnlToken = new sdk_core_1.Token(contracts_1.chainId, (0, utils_1.getAddress)(contracts_1.contractAddresses.vanilla[version].vnl), contracts_1.vnlDecimals);
                                    ...
                                    case 8:
                                        ...
                                        reward = null;
                                        if (!parsedAmountOut) return [3 /*break*/, 10];
                                    ...
                                    case 13:
                                        ...
                                        btrade = contracts_1.epoch
                                            ? ethers_1.BigNumber.from(blockNumber.toString()).sub(contracts_1.epoch)
